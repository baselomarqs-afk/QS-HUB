...
def build_boq_dataframe(
    ...
    add_item("Thermal Block External (GF) (200mm Thickness)", "بلوك حراري خارجي أرضي (سماكة 200mm)", "m²", gf_res.get("thermal_block", 0.0))
    add_item("Internal Block Work (GF) (200mm Thickness)", "بلوك داخلي أرضي (سماكة 200mm)", "m²", gf_res.get("int_block", 0.0))
    add_item("Internal Block Work (GF) (100mm Thickness)", "بلوك داخلي أرضي (سماكة 100mm)", "m²", gf_res.get("int_block_10", 0.0))
    ...
    add_item("Thermal Block External (1F) (200mm Thickness)", "بلوك حراري خارجي أول (سماكة 200mm)", "m²", f1_res.get("thermal_block", 0.0))
    add_item("Internal Block Work (1F) (200mm Thickness)", "بلوك داخلي أول (سماكة 200mm)", "m²", f1_res.get("int_block", 0.0))
    add_item("Internal Block Work (1F) (100mm Thickness)", "بلوك داخلي أول (سماكة 100mm)", "m²", f1_res.get("int_block_10", 0.0))
    ...
    add_item("Thermal Block External (2F) (200mm Thickness)", "بلوك حراري خارجي ثاني (سماكة 200mm)", "m²", f2_res.get("thermal_block", 0.0))
    add_item("Internal Block Work (2F) (200mm Thickness)", "بلوك داخلي ثاني (سماكة 200mm)", "m²", f2_res.get("int_block", 0.0))
    add_item("Internal Block Work (2F) (100mm Thickness)", "بلوك داخلي ثاني (سماكة 100mm)", "m²", f2_res.get("int_block_10", 0.0))
